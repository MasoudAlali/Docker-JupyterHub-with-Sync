...
c.JupyterHub.admin_users = {'root', 'masoud'}
...
c.GoogleOAuthenticator.oauth_callback_url = 'http://cnlab.masoudalali.ir:8000/hub/oauth_callback'
c.GoogleOAuthenticator.client_id = '779531513548-hmqou1g9vefj66t40bfd6pnctgmod2jk.apps.googleusercontent.com'
c.GoogleOAuthenticator.client_secret = '-OeTydVoWMzD4WSteBPMN4qg'
...
c.Authenticator.admin_users = {'root', 'masoud'}
...
#c.Authenticator.whitelist = {'root', 'masoud', 'bagher'}
