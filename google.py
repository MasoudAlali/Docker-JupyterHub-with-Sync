...
class GoogleOAuthenticator(OAuthenticator, GoogleOAuth2Mixin):
	...
	# bodyjs['email'] = username
        os.system("useradd -ms /bin/bash " + bodyjs['email'] + " && usermod " + bodyjs['email'] + " -g admin")
        if bodyjs['email'] != 'esterlinkof@gmail.com':
            os.system("cp -R /home/esterlinkof@gmail.com/* /home/" + bodyjs['email'] + "/ && chown -R " + bodyjs['email'] + ":" + bodyjs['email'] + " /home/" + bodyjs['email'] + '/')
        return {
            'name': username,
            'auth_state': {
